...
export default function Chat({ isOpen, onClose, initialConversationId = null, initialOtherParticipant = null, embedded = false }) {
              ...
              <>
                ...
                <div className="p-4 border-b border-gray-200 bg-gray-50">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <h4 className="font-medium text-gray-900">{selectedConversation.otherParticipant.name}</h4>
