...
export default function Header({ searchQuery, setSearchQuery, onLogoClick, onProfileClick, onSettingsClick, userRole = 'client', onMessagesClick, unreadMessagesCount = 0 }) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-white shadow-sm border-b border-gray-200">
      <div className="flex items-center justify-between px-4 lg:px-6 py-4">
        {/* Logo */}
        <Link to="/dashboard" onClick={handleLogoClick} className="flex items-center gap-2">
