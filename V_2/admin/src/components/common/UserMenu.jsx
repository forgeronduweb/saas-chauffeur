  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className="flex items-center space-x-3 hover:bg-gray-100 dark:hover:bg-orange-100 rounded-lg p-2 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
      >
      ...
      {/* Menu déroulant */}
      {isOpen && (
        <div className="absolute right-0 mt-2 text-sm w-56 p-4 bg-white dark:bg-orange-900 border border-gray-300/30 dark:border-orange-700 text-gray-500 dark:text-orange-400 rounded-md font-medium shadow-lg z-50">
