...
export default function Auth() {
  ...
  const handleLinkedInLogin = () => {
    setLoading(true);
    import('../config/env').then(({ config }) => {
      window.location.href = `${config.api.url}/api/auth/linkedin`;
    });
  };
      ...
      <div className="w-full max-w-md">
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Bienvenue sur GoDriver</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-700">Continuer avec LinkedIn</span>
              </button>
            </div>
          </CardContent>
