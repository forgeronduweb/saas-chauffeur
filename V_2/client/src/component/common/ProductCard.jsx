...
export default function ProductCard({ product }) {
  ...
  return (
    <div 
      className="w-full bg-white border border-gray-300 rounded-lg hover:border-gray-400 hover:shadow-md transition-all duration-200 cursor-pointer group flex flex-col p-1.5 h-full"
      onClick={handleClick}
    >
      {/* Image grande */}
      <figure className="relative h-32 lg:h-48 bg-gray-100 overflow-hidden flex-shrink-0 rounded-md">
        <img 
