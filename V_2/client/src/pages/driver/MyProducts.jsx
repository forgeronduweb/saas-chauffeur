...
export default function MyProducts() {
  ...
  const handleCreateBoost = async () => {
    ...
    try {
      // Créer FormData pour inclure l'image et le texte
                          ...
                          <div className="flex gap-2">
                            ...
                            {!getProductBoost(product._id) && product.status === 'active' && (
                              <button 
                                ...
                                className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white px-2 lg:px-3 py-1 lg:py-1.5 rounded text-xs lg:text-sm transition-all flex items-center gap-1"
                              >
                                <Zap className="w-3 h-3" />
                                Boost
                              </button>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base lg:text-xl text-gray-900">Articles actifs</p>
                      <p className="text-xs text-gray-600">Offres en ligne</p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base lg:text-xl text-gray-900">Articles premium</p>
                      <p className="text-xs text-gray-600">Offres boostées</p>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-base lg:text-xl text-gray-900">Articles simples</p>
                      <p className="text-xs text-gray-600">Offres standards</p>
                    </div>
                  </div>
                </div>
