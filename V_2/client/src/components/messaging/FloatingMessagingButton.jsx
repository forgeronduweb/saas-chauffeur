...
const FloatingMessagingButton = ({ isOpen, onClick, unreadCount = 0 }) => {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-white hover:bg-gray-50 text-gray-900 px-5 py-3 rounded-full shadow-2xl border border-gray-200 transition-all duration-300 hover:shadow-xl group"
